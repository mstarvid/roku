...
Function load_show_feed(conn As Object) As Dynamic
    ...
    'http.Http.SetCertificatesFile("common:/certs/ca-bundle.crt")
    'http.Http.AddHeader("X-Roku-Reserved-Dev-Id", "")
    'http.Http.InitClientCertificates()
...
Function parse_show_feed(xml As Object, feed As Object) As Void
    ...
    for each curShow in showList
        ...
        item.contentRating    = validstr(curShow.contentRating.GetText())
