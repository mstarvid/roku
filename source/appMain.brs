...
Sub Main()
    ...
    if authorized = "success"
        ...
        'd.SetTitle("Internal Error")
		'd.SetText("Oops. We are currently experiencing minor technical difficulties, but we are working hard to correct the problem. In the meantime, you can still watch our entire catalog at http://mstarvid.com.  Click on Blog and Reviews for updates. We apologize for the inconvenience. Please try again later.")
        d.SetText("Ooops.  Looks like your internet connection is down."+Chr(10)+"To make sure your Roku is connected to your Wi-Fi, please follow the simple instructions below: (may vary slightly)"+Chr(10)+"1. Click the Home button on your Roku remote."+Chr(10)+"2. Click the up arrow on your remote to get to" +Chr(34) + "Settings"+Chr(34)+Chr(10)+"3. Click the right arrow to get to " +Chr(34)+"Network" + Chr(34) +", and right again for WiFi, and then one more time and down to set up new Wi-Fi Connection"+Chr(10)+" Select your SSID and type in the key to connect.  If you don't know your SSID or key, call your grandkid / tech guy and ask them to do it for you :-)")
        d.AddButton(1, "OK")
        d.Show()
