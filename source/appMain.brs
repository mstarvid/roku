...
Sub Main()
    ...
    if authorized = "success"
        ...
        d.SetText("Oops. It appears you do not have an active MorningStar Video account. Please go to www.mstarvid.com to register or upgrade your account. If you need any assistance, please contact us at support@mstarvid.com")
        d.AddButton(1, "OK")
        d.Show()
        ...
        d.SetText("Oops. An unknown error has occurred. Please contact tech support for further assistance by emailing us at support@mstarvid.com")
        d.AddButton(1, "OK")
        d.Show()
        ...
        d.SetText("Ooops.  Looks like your internet connection is down. Please double check that your Roku is connected to the internet. If this issue persists, or or you need any assistance, please contact us at support@mstarvid.com.")
        d.AddButton(1, "OK")
        d.Show()
